...
import { create, ellipsisHorizontal, ellipsisVertical, helpCircle, search, personCircle, star, personAddOutline,notificationsOutline, logOutOutline, newspaperOutline, peopleCircleOutline } from 'ionicons/icons';
...
function OnAddInfo(): void {
  setShowAddInfo(true);
}

function OnActualite(): void{
  setShowActualite(true);
}
...
const hideActualite = () => {
  ...
  <IonToolbar>
    <IonButtons slot="secondary">
      <IonButton onClick={() => { OnActualite(); hideAddInfo(); }}>
        <IonIcon slot="icon-only" icon={peopleCircleOutline} />
      </IonButton>

      <IonButton onClick={() => { OnAddInfo(); hideActualite(); }}>
        <IonIcon slot="icon-only" icon={newspaperOutline} />
      </IonButton>

      <IonButton onClick={() => handleRedirection('/accueil/list')}>
        <IonIcon slot="icon-only" icon={personCircle} />
      </IonButton>

      <IonButton onClick={() => handleRedirection('/acueil/addmembre')}>
    ...
    <IonTitle>Gestion Etudiant</IonTitle>
  </IonToolbar>
</IonHeader>
        ...
        <p>Bienvenue   </p>
        <p>Vous êtes connecté en tant qu&apos;administrateur. {utilisateurNom} {utilisateurPrenom}</p>
        
        
        {/* Composant Modification */}
        {showActualite && <Actualite onClose={hideActualite} />}
      
          

            {/* Composant Modification */}
          {showAddInfo && <AddInfo onClose={hideAddInfo} />}
